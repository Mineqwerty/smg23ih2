...
enum SoundBank {
    ...
    SOUND_BANK_GENERAL2,
    SOUND_BANK_OBJ2,
    SOUND_BANK_CUSTOM_MISC,
    SOUND_BANK_CUSTOM_BLOCKINGTON,
    SOUND_BANK_COUNT
};
...
#define SOUND_BANKS_FOREGROUND (\
    ...
    (1 << SOUND_BANK_VOICE) |\
    (1 << SOUND_BANK_MENU) |\
    (1 << SOUND_BANK_CUSTOM_MISC) |\
    (1 << SOUND_BANK_CUSTOM_BLOCKINGTON))
...
#define BLOCKINGTON_SOUND_FLAGS (SOUND_DISCRETE | SOUND_NO_PRIORITY_LOSS | SOUND_CONSTANT_FREQUENCY)
...
#define SOUND_ACTION_HIT_HIDDEN_BLOCK            /* 0x0470A081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x70, 0xA0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_ACTION_CUSTOM_TELEPORT             /* 0x0471C080 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x71, 0xC0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
#define SOUND_MARIO_ATTACKED                     /* 0x240AF081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x0A, 0xF0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
...
#define SOUND_MARIO_HAHA_WATER                   /* 0x2411E081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x11, 0xE0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
...
#define SOUND_MARIO_DYING                        /* 0x2415F081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x15, 0xF0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
...
#define SOUND_MARIO_DROWNING                     /* 0x2423E081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x23, 0xE0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
#define SOUND_MARIO_GAME_OVER                    /* 0x2431F081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x31, 0xF0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_MARIO_HELLO                        /* 0x2432F081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x32, 0xF0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_MARIO_PRESS_START_TO_PLAY          /* 0x2433F0A1 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x33, 0xF0, SOUND_NO_PRIORITY_LOSS | SOUND_NO_ECHO | SOUND_DISCRETE)
...
#define SOUND_MARIO_SNORING3                     /* 0x2435F081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x35, 0xF0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
#define SOUND_PEACH_MARIO                        /* 0x2438F081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x38, 0xF0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_PEACH_POWER_OF_THE_STARS           /* 0x2439F081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x39, 0xF0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_PEACH_THANKS_TO_YOU                /* 0x243AF081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x3A, 0xF0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_PEACH_THANK_YOU_MARIO              /* 0x243BF081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x3B, 0xF0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_PEACH_SOMETHING_SPECIAL            /* 0x243CF081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x3C, 0xF0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_PEACH_BAKE_A_CAKE                  /* 0x243DF081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x3D, 0xF0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_PEACH_FOR_MARIO                    /* 0x243EF081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x3E, 0xF0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_PEACH_MARIO2                       /* 0x243FF081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x3F, 0xF0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_MARIO_CLASSIC_DEATH                /* 0x2440FF81 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x40, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_MARIO_YAHOO_UNPITCHED              /* 0x2441E081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x41, 0xE0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
...
#define SOUND_RAGDOLL                            /* 0x045F8080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x77, 0xC0, SOUND_DISCRETE)
...
#define SOUND_OBJ_HIDDEN_BLOCK_ITEM              /* 0x5080C081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x80, 0xC0, SOUND_DISCRETE)
#define SOUND_OBJ_CAR_DOOR_OPEN                  /* 0x50810081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x81, 0x80, SOUND_DISCRETE)
#define SOUND_OBJ_CAR_DOOR_SHUT                  /* 0x50820081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x82, 0x80, SOUND_DISCRETE)
...
#define SOUND_MENU_SONIC_LOSE_RINGS              /* 0x70258081 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x25, 0x80, SOUND_DISCRETE)
#define SOUND_MENU_PATCHY                        /* 0x70268081 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x26, 0xFF, SOUND_DISCRETE)
...
#define SOUND_MENU_COLLECT_RED_COIN2_0           /* 0x78409081 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x40, 0x90, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE)
#define SOUND_MENU_COLLECT_RED_COIN2_1           /* 0x78419081 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x41, 0x90, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE)
#define SOUND_MENU_COLLECT_RED_COIN2_2           /* 0x78429081 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x42, 0x90, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE)
#define SOUND_MENU_COLLECT_RED_COIN2_3           /* 0x78439081 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x43, 0x90, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE)
#define SOUND_MENU_COLLECT_RED_COIN2_4           /* 0x78449081 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x44, 0x90, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE)
#define SOUND_MENU_COLLECT_RED_COIN2_5           /* 0x78459081 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x45, 0x90, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE)
#define SOUND_MENU_COLLECT_RED_COIN2_6           /* 0x78469081 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x46, 0x90, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE)
#define SOUND_MENU_COLLECT_RED_COIN2_7           /* 0x78479081 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x47, 0x90, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE)
#define SOUND_MENU_COLLECT_RED_COIN2_8           /* 0x78489081 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x48, 0x90, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE)
#define SOUND_MENU_COLLECT_RED_COIN2_9           /* 0x78499081 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x49, 0x90, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE)
#define SOUND_MENU_COLLECT_RED_COIN2_10          /* 0x784A9081 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x4A, 0x90, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE)
#define SOUND_MENU_COLLECT_RED_COIN2_11          /* 0x784B9081 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x4B, 0x90, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE)
...
#define SOUND_OBJ2_HIDDEN_BLOCK_ITEM             /* 0x9080C081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ2,     0x80, 0xC0, SOUND_DISCRETE)
#define SOUND_OBJ2_CAR_DOOR_OPEN                 /* 0x90810081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ2,     0x81, 0x80, SOUND_DISCRETE)
#define SOUND_OBJ2_CAR_DOOR_SHUT                 /* 0x90820081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ2,     0x82, 0x80, SOUND_DISCRETE)


// Channel Custom Misc (0xA) Sound Effects
#define SOUND_CUSTOM_MISC_MARIO_MAKER_LAUGH_0       /* 0xA0000081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x00, 0x00, SOUND_DISCRETE)
#define SOUND_CUSTOM_MISC_MARIO_MAKER_LAUGH_1       /* 0xA0010081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x01, 0x00, SOUND_DISCRETE)
#define SOUND_CUSTOM_MISC_MARIO_MAKER_LAUGH_2       /* 0xA0020081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x02, 0x00, SOUND_DISCRETE)
#define SOUND_CUSTOM_MISC_KICK_SHELL                /* 0xA0032081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x03, 0x20, SOUND_DISCRETE)
#define SOUND_CUSTOM_MISC_SQUID_WORD_SCREAM         /* 0xA0041081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x04, 0x10, SOUND_DISCRETE)
#define SOUND_CUSTOM_MISC_SURPRISE_CHUCKYA          /* 0xA0052081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x05, 0x20, SOUND_DISCRETE)
#define SOUND_CUSTOM_MISC_P_BATTLE_START            /* 0xA0062081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x06, 0x20, SOUND_DISCRETE)
#define SOUND_CUSTOM_MISC_P_MENU_ROTATE             /* 0xA0070081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x07, 0x00, SOUND_DISCRETE)
#define SOUND_CUSTOM_MISC_P_SELECTOR                /* 0xA0080081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x08, 0x00, SOUND_DISCRETE)
#define SOUND_CUSTOM_MISC_P_CANCEL                  /* 0xA0090081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x09, 0x00, SOUND_DISCRETE)
#define SOUND_CUSTOM_MISC_P_INVALID                 /* 0xA00A0081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x0A, 0x00, SOUND_DISCRETE)
#define SOUND_CUSTOM_MISC_P_SCROLL                  /* 0xA00B0081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x0B, 0x00, SOUND_DISCRETE)
#define SOUND_CUSTOM_MISC_P_CONFIRM                 /* 0xA00C0081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x0C, 0x00, SOUND_DISCRETE)
#define SOUND_CUSTOM_BLOCKINGTON_NPC_DEATH_0        /* 0xA00D0081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x0D, 0x00, SOUND_DISCRETE)
#define SOUND_CUSTOM_BLOCKINGTON_NPC_DEATH_1        /* 0xA00E0081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x0E, 0x00, SOUND_DISCRETE)
#define SOUND_CUSTOM_BLOCKINGTON_NPC_DEATH_2        /* 0xA00F0081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x0F, 0x00, SOUND_DISCRETE)
#define SOUND_CUSTOM_BLOCKINGTON_NPC_DEATH_3        /* 0xA0100081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x10, 0x00, SOUND_DISCRETE)
#define SOUND_CUSTOM_BLOCKINGTON_NPC_CHILD_DEATH_0  /* 0xA0110081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x11, 0x00, SOUND_DISCRETE)
#define SOUND_CUSTOM_BLOCKINGTON_NPC_CHILD_DEATH_1  /* 0xA0120081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x12, 0x00, SOUND_DISCRETE)
#define SOUND_CUSTOM_BLOCKINGTON_NPC_CHILD_DEATH_2  /* 0xA0130081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x13, 0x00, SOUND_DISCRETE)
#define SOUND_CUSTOM_BLOCKINGTON_NPC_CHILD_DEATH_3  /* 0xA0140081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x14, 0x00, SOUND_DISCRETE)
#define SOUND_CUSTOM_MISC_GUN_DRAW                  /* 0xA0154081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x15, 0x40, SOUND_DISCRETE)
#define SOUND_CUSTOM_MISC_GUN_FIRE                  /* 0xA0164081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x16, 0x50, SOUND_DISCRETE)
#define SOUND_CUSTOM_MISC_NSMBW_MINI_MUSHROOM       /* 0xA0174081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_MISC, 0x17, 0x10, SOUND_DISCRETE)


// Channel Custom Blockington (0xB) Sound Effects
// NOTE: This is to be used for Blockington voice lines ONLY! Other uses have a nonzero chance of breaking stuff.
#define SOUND_BLOCKINGTON_OOB                    /* 0xBC000081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x00, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_COIN_00                /* 0xBC010081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x01, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_COIN_02                /* 0xBC020081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x02, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_COIN_03                /* 0xBC030081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x03, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_COIN_06                /* 0xBC040081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x04, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_COIN_07                /* 0xBC050081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x05, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_COIN_10                /* 0xBC060081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x06, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_COIN_12_NORMAL         /* 0xBC070081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x07, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_COIN_12_PITY           /* 0xBC080081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x08, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_COIN_13                /* 0xBC090081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x09, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_COIN_JACKPOT           /* 0xBC0A0081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x0A, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_COIN_23                /* 0xBC0B0081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x0B, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_PITY_BRIDGE            /* 0xBC0C0081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x0C, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CRINGE_PATH_0          /* 0xBC0D0081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x0D, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CRINGE_PATH_1_0        /* 0xBC0E0081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x0E, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CRINGE_PATH_1_1        /* 0xBC0F0081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x0F, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CRINGE_PATH_2          /* 0xBC100081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x10, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CRINGE_PATH_COLLECT    /* 0xBC110081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x11, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CS_MARIO_0             /* 0xBC120081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x12, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CS_MARIO_1             /* 0xBC130081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x13, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CS_CAR_0               /* 0xBC140081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x14, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CS_CAR_1               /* 0xBC150081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x15, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CS_CAR_2               /* 0xBC160081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x16, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CS_FIRST_AREA_0        /* 0xBC170081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x17, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CS_FIRST_AREA_1        /* 0xBC180081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x18, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CS_FIRST_AREA_2        /* 0xBC190081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x19, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CS_FIRST_AREA_3        /* 0xBC1A0081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x1A, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CS_FIRST_AREA_4        /* 0xBC1B0081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x1B, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CS_SECOND_AREA_0       /* 0xBC1C0081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x1C, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CS_SECOND_AREA_1       /* 0xBC1D0081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x1D, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CS_SECOND_AREA_2       /* 0xBC1E0081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x1E, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CS_FINAL_0_0           /* 0xBC1F0081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x1F, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CS_FINAL_0_1           /* 0xBC200081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x20, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CS_FINAL_0_2           /* 0xBC210081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x21, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CS_FINAL_1_0           /* 0xBC220081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x22, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CS_FINAL_1_1           /* 0xBC230081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x23, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CS_FINAL_1_2           /* 0xBC240081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x24, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CS_FINAL_1_3           /* 0xBC250081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x25, 0x00, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CS_ADLIB               /* 0xB4260001 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x26, 0x10, SOUND_NO_PRIORITY_LOSS)
#define SOUND_BLOCKINGTON_CS_DEATH_0             /* 0xBC270081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x27, 0x20, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CS_DEATH_1             /* 0xBC280081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x28, 0x30, BLOCKINGTON_SOUND_FLAGS)
#define SOUND_BLOCKINGTON_CS_DEATH_2             /* 0xBC290081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BLOCKINGTON, 0x29, 0x40, BLOCKINGTON_SOUND_FLAGS)
