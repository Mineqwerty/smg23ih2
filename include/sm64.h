...
enum RenderLayers {
    ...
    LAYER_FORCE_ALPHA_ON_TOP,
    LAYER_FORCE_TRANSPARENT_ON_TOP,
    LAYER_COUNT
};
...
#define ACT_CLASSIC_DEATH              0x0000130B // (0x10B | ACT_FLAG_STATIONARY | ACT_FLAG_INTANGIBLE)
#define ACT_PERSONA_BATTLE_TRANSITION                 0x0000130C // (0x10C)
#define ACT_PERSONA_BATTLE                 0x0000010D // (0x10D)
...
#define ACT_FAZANA_CAR                 0x00020910 // (0x110 | ACT_FLAG_AIR | ACT_FLAG_INVULNERABLE)
...
#define ACT_CHECKPOINT_WARP            0x0000191F // (0x11F | ACT_FLAG_AIR | ACT_FLAG_INTANGIBLE)
