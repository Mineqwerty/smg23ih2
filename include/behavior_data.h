...
extern const BehaviorScript bhvBounceyRedCoinGetsSpawned[];
...
extern const BehaviorScript bhvOffscreenThwomp[];
...
extern const BehaviorScript bhvCheckpointWarp[];
...
extern const BehaviorScript bhvRHDCPFP[];
