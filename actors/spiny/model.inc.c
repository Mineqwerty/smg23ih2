...
const Gfx spiny_seg5_dl_05016418[] = {
    gsSPLightColor(LIGHT_1, 0xca8d29ff),
    gsSPLightColor(LIGHT_2, 0x32230aff),
    ...
    gsSPLightColor(LIGHT_1, 0xebb07fff),
    gsSPLightColor(LIGHT_2, 0x3a2c1fff),
...
const Gfx spiny_seg5_dl_05016738[] = {
    ...
    gsSPLightColor(LIGHT_1, 0xf49607ff),
    gsSPLightColor(LIGHT_2, 0x3d2501ff),
    ...
    gsSPLightColor(LIGHT_1, 0xf1b225ff),
    gsSPLightColor(LIGHT_2, 0x3c2c09ff),
