...
const GeoLayout peach_geo_000098[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         GEO_ANIMATED_PART(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, 0, 0, 0, peach_seg5_dl_05007230),
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, 78, 0, 0, peach_seg5_dl_05006A18),
            GEO_OPEN_NODE(),
               ...
               GEO_ASM(0, geo_peach_head_scaler),
                  ...
                  GEO_OPEN_NODE(),
                     ...
                     GEO_DISPLAY_LIST(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, peach_seg5_dl_05005D90),
                     GEO_DISPLAY_LIST(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, peach_seg5_dl_05005DE8),
                     GEO_DISPLAY_LIST(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, peach_seg5_dl_05005E40),
                     GEO_DISPLAY_LIST(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, peach_seg5_dl_05005E98),
                     GEO_DISPLAY_LIST(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, peach_seg5_dl_05005EF0),
                     GEO_DISPLAY_LIST(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, peach_seg5_dl_05005F48),
                  GEO_CLOSE_NODE(),
               ...
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, 0, 0, 0, peach_seg5_dl_05007E58),
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, 104, 0, 0, peach_seg5_dl_050087A8),
                     GEO_OPEN_NODE(),
                        GEO_ANIMATED_PART(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, 87, 0, 0, peach_seg5_dl_05009500),
                     GEO_CLOSE_NODE(),
                  GEO_CLOSE_NODE(),
                  GEO_ANIMATED_PART(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, 0, 0, 0, peach_seg5_dl_05008560),
               GEO_CLOSE_NODE(),
               GEO_ANIMATED_PART(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, 63, 0, -84, NULL),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, 0, 0, 0, peach_seg5_dl_05008228),
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, 104, 0, 0, peach_seg5_dl_05008CF8),
                     GEO_OPEN_NODE(),
                        GEO_ANIMATED_PART(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, 87, 0, 0, peach_seg5_dl_05009940),
                     GEO_CLOSE_NODE(),
                  GEO_CLOSE_NODE(),
                  GEO_ANIMATED_PART(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, 0, 0, 0, peach_seg5_dl_05008AB0),
               GEO_CLOSE_NODE(),
            GEO_CLOSE_NODE(),
            GEO_ANIMATED_PART(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, 78, 0, 0, peach_seg5_dl_050060E0),
            GEO_ANIMATED_PART(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, -23, -1, 0, NULL),
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, 0, 0, 0, peach_seg5_dl_0500A0A8),
            GEO_CLOSE_NODE(),
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
   GEO_CLOSE_NODE(),
