...
struct BlockingtonMiniDialog bMiniDiaCSMario[] = {
    ...
    {.lineCount = 3, .soundID = SOUND_BLOCKINGTON_CS_MARIO_1, .dialogStr = "Now, with all due respect,\nwould you please kindly get\nthe hell out of here!"},
};

// Cutscene Car
struct BlockingtonMiniDialog bMiniDiaCSCar[] = {
    {.lineCount = 3, .soundID = SOUND_BLOCKINGTON_CS_CAR_0, .dialogStr = "Hmm, you look interesting. You don't\nexactly meet the block standards but\nehhh, you're close enough."},
    {.lineCount = 3, .soundID = SOUND_BLOCKINGTON_CS_CAR_1, .dialogStr = "Blocktaria is in too much trouble\nto nitpick at the highest detail!\nWe need someone to save us!"},
...
struct BlockingtonMiniDialog bMiniDiaCSFirstArea[] = {
    {.lineCount = 2, .soundID = SOUND_BLOCKINGTON_CS_FIRST_AREA_0, .dialogStr = "Now, we have something of a\ncritical problem here."},
    ...
    {.lineCount = 4, .soundID = SOUND_BLOCKINGTON_CS_FIRST_AREA_2, .dialogStr = "Oh, HOW am I supposed to get over\nthere now? We need somebody to\nrescue all of the artifacts in order\nto reconstruct this bridge!"},
    ...
    {.lineCount = 3, .soundID = SOUND_BLOCKINGTON_CS_FIRST_AREA_4, .dialogStr = "In the meantime, I'll be\nwaiting for you over there on\nthe other side. Now get to work!"},
};
...
struct BlockingtonMiniDialog bMiniDiaCSSecondArea[] = {
    ...
    {.lineCount = 2, .soundID = SOUND_BLOCKINGTON_CS_SECOND_AREA_1, .dialogStr = "Can you help me rebuild this\nbridge too? PLEEEEASE?\n:("},
    {.lineCount = 3, .soundID = SOUND_BLOCKINGTON_CS_SECOND_AREA_2, .dialogStr = "I'll be waiting for you on\nmy favorite island. Don't keep\nme waiting!"},
};
...
struct BlockingtonMiniDialog bMiniDiaCSFinal0[] = {
    ...
    {.lineCount = 2, .soundID = SOUND_BLOCKINGTON_CS_FINAL_0_1, .dialogStr = "You were able to restore peace\nto our world!"},
...
struct BlockingtonMiniDialog bMiniDiaCSFinal1[] = {
    ...
    {.lineCount = 3, .soundID = SOUND_BLOCKINGTON_CS_FINAL_1_2, .dialogStr = "I thought I made myself clear\nthat you are not permitted entry to\nthis world!"},
