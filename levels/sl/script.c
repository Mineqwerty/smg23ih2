...
const LevelScript level_sl_entry[] = {
	...
	AREA(1, sl_area_1),
		...
		OBJECT(MODEL_NONE, 0, 0, 0, 0, 0, 0, (0 << 16) | (250), bhvCheckpoint),
		OBJECT(MODEL_GOOMBA, -43, 0, -1771, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_NONE, 0, 200, 0, 0, 180, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 180, 200, 0, 0),
	...
	AREA(2, sl_area_2),
		...
		OBJECT(MODEL_COWARDLY_MAYA, -911, 0, 1069, 0, 66, 0, (1 << 16), bhvCowardlyMaya),
		OBJECT(MODEL_COWARDLY_MAYA, -731, 0, 234, 0, 32, 0, (2 << 16), bhvCowardlyMaya),
		...
		SET_BACKGROUND_MUSIC(0x00, SEQ_STREAMED_MASS_DESTRUCTION),
		TERRAIN_TYPE(TERRAIN_GRASS),
		/* Fast64 begin persistent block [area commands] */
		/* Fast64 end persistent block [area commands] */
	END_AREA(),
