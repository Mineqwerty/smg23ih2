...
const LevelScript level_castle_grounds_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_WII, wii_geo), 
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_RED_COIN, -3697, 214, -1345, 0, 0, 0, (7 << 16), bhvRedCoin),
		OBJECT(MODEL_FLYGUY, -1612, 1003, 3869, 0, 0, 0, 0x00000000, bhvHiddenRedCoinStar),
		OBJECT(MODEL_RED_COIN, -4443, 360, -1345, 0, 0, 0, (6 << 16), bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 3568, -1289, -4368, 0, 0, 0, (0 << 16), bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -1362, 799, 10289, 0, 0, 0, (4 << 16), bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 3359, 1197, 12206, 0, 0, 0, (3 << 16), bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -30, 799, 17616, 0, 0, 0, (1 << 16), bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -7001, 1425, 2062, 0, 0, 0, (5 << 16), bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -61, 1178, 10492, 0, 0, 0, (2 << 16), bhvRedCoin),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, -270, 799, 10768, 0, 0, 0, (34 << 16), bhvMessagePanel),
		...
		OBJECT(MODEL_CASTLE_GROUNDS_BUBBLY_TREE, -5234, 212, 4856, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_CASTLE_GROUNDS_BUBBLY_TREE, -2712, 799, 8504, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_CASTLE_GROUNDS_BUBBLY_TREE, 5380, 212, 8733, 0, 0, 0, 0x00000000, bhvTree),
		...
		OBJECT(MODEL_WII, -61, 799, 10492, 0, 0, 0, 0x00000000, bhvWii),
