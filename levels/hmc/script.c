...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		OBJECT(MODEL_CQ_BRIDGE, -21387, 4209, 23266, 0, -90, 0, 0x00000000, bhvCQBridge),
		...
		OBJECT(MODEL_CQ_RED_CUBE, -2093, 8271, 16972, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_CQ_GATE, 0, 231, -2618, 0, 0, 0, 0x00000000, bhvCQGate),
		OBJECT(MODEL_NONE, -27418, 6104, 22957, 0, 0, 0, (1), bhvHiddenRedCoinStar),
		...
		OBJECT(MODEL_CQ_RED_CUBE, 23773, 5507, 11840, 0, 0, 0, (12 << 16) | (1), bhvRedCoin),
		OBJECT(MODEL_CQ_RED_CUBE, 20409, 7309, 14095, 0, 0, 0, (13 << 16) | (1), bhvRedCoin),
		OBJECT(MODEL_CQ_RED_CUBE, 11290, 4318, 20644, 0, 0, 0, (14 << 16) | (1), bhvRedCoin),
		OBJECT(MODEL_CQ_RED_CUBE, 10637, 4318, 21672, 0, 0, 0, (15 << 16) | (1), bhvRedCoin),
		OBJECT(MODEL_CQ_RED_CUBE, 10081, 4318, 23247, 0, 0, 0, (16 << 16) | (1), bhvRedCoin),
		OBJECT(MODEL_CQ_RED_CUBE, 8699, 4318, 25503, 0, 0, 0, (17 << 16) | (1), bhvRedCoin),
		OBJECT(MODEL_CQ_RED_CUBE, 6867, 4318, 26596, 0, 0, 0, (18 << 16) | (1), bhvRedCoin),
		OBJECT(MODEL_CQ_RED_CUBE, 9464, 4318, 24613, 0, 0, 0, (19 << 16) | (1), bhvRedCoin),
		OBJECT(MODEL_CQ_RED_CUBE, -6155, 4971, 18453, 0, 0, 0, (20 << 16) | (1), bhvRedCoin),
		OBJECT(MODEL_CQ_RED_CUBE, -6155, 4971, 24626, 0, 0, 0, (21 << 16) | (1), bhvRedCoin),
		OBJECT(MODEL_CQ_RED_CUBE, -14906, 4318, 22980, 0, 0, 0, (22 << 16) | (1), bhvRedCoin),
		OBJECT(MODEL_CQ_RED_CUBE, 10080, 5151, 23030, 0, 0, 0, (23 << 16) | (1), bhvRedCoin),
