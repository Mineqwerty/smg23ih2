...
const LevelScript level_wf_entry[] = {
	...
	AREA(2, wf_area_2),
		...
		OBJECT(MODEL_BOWLING_BALL, -4831, 465, -4132, 0, 0, 0, 0x00000000, bhvBowlingBall),
		...
		OBJECT(MODEL_CHUCKYA, -4840, 829, -9306, 0, 90, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_CHUCKYA, -4840, 829, -9073, 0, 90, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_CHUCKYA, -4840, 829, -8811, 0, 90, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_CHUCKYA, -4840, 829, -8532, 0, 90, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_CHUCKYA, -4840, 829, -8262, 0, 90, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_CHUCKYA, -4840, 829, -7996, 0, 90, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_CHUCKYA, -4840, 829, -7752, 0, 90, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_CHUCKYA, -4840, 829, -7490, 0, 90, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_CHUCKYA, -4840, 829, -9357, 0, 90, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_CHUCKYA, -4840, 829, -9124, 0, 90, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_CHUCKYA, -4840, 829, -8862, 0, 90, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_CHUCKYA, -4840, 829, -8583, 0, 90, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_CHUCKYA, -4840, 829, -8313, 0, 90, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_CHUCKYA, -4840, 829, -8046, 0, 90, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_CHUCKYA, -4840, 829, -7802, 0, 90, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_CHUCKYA, -4840, 829, -7540, 0, 90, 0, 0x00000000, bhvChuckya),
		...
		OBJECT(MODEL_HIDDEN_BLOCK, 904, 282, -6524, 0, 90, 0, (6), bhvHiddenBlock),
		OBJECT(MODEL_HIDDEN_BLOCK, 631, 282, -6524, 0, 90, 0, (6), bhvHiddenBlock),
		...
		OBJECT(MODEL_HIDDEN_BLOCK, -4555, 1200, 6851, 0, 90, 0, (1 << 16) | (6), bhvHiddenBlock),
		OBJECT(MODEL_HIDDEN_BLOCK, -4555, 1200, 7160, 0, 90, 0, (1 << 16) | (6), bhvHiddenBlock),
