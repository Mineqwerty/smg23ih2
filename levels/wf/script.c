...
const LevelScript level_wf_entry[] = {
	...
	AREA(2, wf_area_2),
		...
		OBJECT(MODEL_BLACK_BOBOMB, -4815, 829, -9780, 0, 90, 0, (BOBOMB_BP_STYPE_STATIONARY << 16), bhvBobomb),
		OBJECT(MODEL_BREAKABLE_BOX, -4815, 829, -9365, 0, 0, 0, (1 << 8), bhvBreakableBox),
		OBJECT(MODEL_BREAKABLE_BOX, -4815, 829, -9023, 0, 0, 0, (1 << 8), bhvBreakableBox),
		OBJECT(MODEL_BREAKABLE_BOX, -4815, 829, -8681, 0, 0, 0, (1 << 8), bhvBreakableBox),
		OBJECT(MODEL_BREAKABLE_BOX, -4815, 829, -8339, 0, 0, 0, (2 << 8), bhvBreakableBox),
		OBJECT(MODEL_BREAKABLE_BOX, -4815, 829, -7997, 0, 0, 0, (1 << 8), bhvBreakableBox),
		OBJECT(MODEL_BREAKABLE_BOX, -4815, 829, -7655, 0, 0, 0, (1 << 8), bhvBreakableBox),
		OBJECT(MODEL_BULLET_BILL, -4815, 625, -4000, 0, -180, 0, 0x00000000, bhvHiddenBulletBill),
		...
		OBJECT(MODEL_NONE, -4655, 829, -6269, 0, 90, 0, (11 << 16), bhvDoorWarp),
		OBJECT(MODEL_NONE, -4815, 829, -6025, 0, -180, 0, (11 << 16), bhvDoorWarp),
		OBJECT(MODEL_NONE, -4500, 829, -3241, 0, -180, 0, (11 << 16), bhvDoorWarp),
		OBJECT(MODEL_NONE, -5130, 829, -3241, 0, -180, 0, (11 << 16), bhvDoorWarp),
		...
		OBJECT(MODEL_HIDDEN_BLOCK, -4663, 1060, -7320, 0, 0, 0, (0x08 << 8) | (6), bhvHiddenBlock),
		OBJECT(MODEL_HIDDEN_BLOCK, -4813, 1060, -7320, 0, 0, 0, (0x08 << 8) | (6), bhvHiddenBlock),
		...
		OBJECT(MODEL_HIDDEN_BLOCK, -4967, 1060, -7320, 0, 0, 0, (0x08 << 8) | (6), bhvHiddenBlock),
		OBJECT(MODEL_HIDDEN_BLOCK, -4663, 1060, -7168, 0, 0, 0, (0x08 << 8) | (6), bhvHiddenBlock),
		OBJECT(MODEL_HIDDEN_BLOCK, -4813, 1060, -7168, 0, 0, 0, (0x08 << 8) | (6), bhvHiddenBlock),
		OBJECT(MODEL_HIDDEN_BLOCK, -4967, 1060, -7168, 0, 0, 0, (0x08 << 8) | (6), bhvHiddenBlock),
		OBJECT(MODEL_HIDDEN_BLOCK, -2456, 829, -9780, 0, 0, 0, (6), bhvHiddenBlock),
		OBJECT(MODEL_THWOMP, -4815, 1729, -320, 0, -180, 0, (128 << 16), bhvOffscreenThwomp),
