...
const GeoLayout ttc_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -2312, 3698, -8167, ttc_dl_f3dlite_material_005Mesh_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, ttc_dl_fake_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, ttc_dl_Plane_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_ALPHA, ttc_dl_Plane_mesh_layer_4),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
