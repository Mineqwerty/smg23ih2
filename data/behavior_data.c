...
const BehaviorScript bhvAgiParticle[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BILLBOARD(),
    SET_HOME(),
    SCALE(/*Unused*/ 0, /*Field*/ 600),
    CALL_NATIVE(bhv_agi_particle_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_agi_particle_loop),
        ANIMATE_TEXTURE(oAnimState, 2),
    END_LOOP(),
};
...
const BehaviorScript bhvConfetti[] = {
    BEGIN(OBJ_LIST_UNIMPORTANT),
    OR_INT(oFlags, (OBJ_FLAG_ACTIVE_FROM_AFAR | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BILLBOARD(),
    CALL_NATIVE(bhv_confetti_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_confetti_loop),
    END_LOOP(),
};
...
const BehaviorScript bhvBlockingtonChild[] = {
    BEGIN(OBJ_LIST_PUSHABLE),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    DROP_TO_FLOOR(),
    LOAD_ANIMATIONS(oAnimations, goomba_seg8_anims_0801DA4C),
    ...
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 40, /*Gravity*/ -400, /*Bounciness*/ -50, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 0, /*Unused*/ 0, 0),
    SET_FLOAT(oDrawingDistance, 20000),
    CALL_NATIVE(bhv_blockington_child_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_goomba_update),
    END_LOOP(),
};
...
const BehaviorScript bhvWii[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(wii_collision),
    CALL_NATIVE(bhv_wii_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_wii_loop),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};
